...
public class BerretacoinTests {
     ...
     * Transaccion tx = new Transaccion(transacciones.size(), comprador, vendedor,
     * monto);
     ...
     * assertEquals(monto_medio, sistema.montoMedioUltimoBloque());
     * assertTrue(Arrays.equals(transacciones.toArray(new Transaccion[0]),
     * sistema.txUltimoBloque()));
     * assertEquals(tracker.getMaximoTenedor(), sistema.maximoTenedor());
     * }
     * }
     * }
